...
The previously pending dependency runs in `gmail-resume-mailer` (`32054997247`) and `pharma-qa-job-tracker` (`32055617946`) have both completed as **cancelled**. They are therefore historical GitHub-managed automation events rather than active queue blockers.
